...
class ReactDisplayNamePlugin  {
  ...
  apply(compiler) {
    ...
    compiler.hooks.normalModuleFactory.tap('ReactDisplayNamePlugin', factory => {
      factory.hooks.parser.for('javascript/auto').tap('ReactDisplayNamePlugin', parser => {
        parser.hooks.program.tap("ReactDisplayNamePlugin", ast => {
